...
set_clock_uncertainty -rise_from [get_clocks {clk50}] -rise_to [get_clocks {clk50}] -setup 0.170  
set_clock_uncertainty -rise_from [get_clocks {clk50}] -rise_to [get_clocks {clk50}] -hold 0.060  
set_clock_uncertainty -rise_from [get_clocks {clk50}] -fall_to [get_clocks {clk50}] -setup 0.170  
set_clock_uncertainty -rise_from [get_clocks {clk50}] -fall_to [get_clocks {clk50}] -hold 0.060  
set_clock_uncertainty -fall_from [get_clocks {clk50}] -rise_to [get_clocks {clk50}] -setup 0.170  
set_clock_uncertainty -fall_from [get_clocks {clk50}] -rise_to [get_clocks {clk50}] -hold 0.060  
set_clock_uncertainty -fall_from [get_clocks {clk50}] -fall_to [get_clocks {clk50}] -setup 0.170  
